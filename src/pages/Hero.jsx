    ...
    return (
        <section id="about">
            <div className="px-4 mx-auto max-w-screen-xl text-center pt-20 lg:px-4">
                <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                ...
                <div className="grid max-w-screen-xl px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7  text-center md:text-left py-10 md:py-0">
                        ...
                        <h1 className="max-w-2xl mb-4 text-black text-2xl font-extrabold tracking-tight leading-none md:text-4xl lg:text-3xl xl:text-4xl dark:text-white">Ingénieur - Developper / CIAM</h1>
